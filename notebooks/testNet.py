...
if __name__ == '__main__':
    ...
    imagenet = torchvision.datasets.ImageNet(
        root="./data", split='val', transform=normalize)
    ...
    while True:
        ...
        ece1 = torchmetrics.functional.classification.multiclass_calibration_error(predictions, targets, n_bins=15, num_classes=1000)
        ...
        ece2 = torchmetrics.functional.classification.multiclass_calibration_error(ts_predictions, ts_targets, n_bins=15, num_classes=1000)
        ...
        ece3 = torchmetrics.functional.classification.multiclass_calibration_error(new_logits, torch.tensor(targets), n_bins=15, num_classes=1000)
        ...
        #write to file
        with open('resultsIMAGENET.txt', 'a') as f:
